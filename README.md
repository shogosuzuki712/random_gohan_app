...
- 投稿方法
  ...
  - テストアカウントでログイン→「シェア」ボタン押下→投稿情報入力→保存する押下→投稿完了です
...
# 制作背景（意図）
まず前提として、自身を優柔不断だと思っている人口の割合は25％だそうです。

（※47都道府県別生活意識調査より）

優柔不断じゃない人でも、ごはん何食べようか悩んだ経験は必ずあると思っています。実際、私も一人暮らしをしていた頃は毎晩何を食べるか悩み、ストレスを感じてました。

そこで自身の経験を踏まえつつ、優柔不断な方、仕事をしている一人暮らしの方や主婦の方などをターゲットとし、時間短縮でき脳のエネルギーを使わずとも食べるごはんを決めてくれるアプリケーションを制作しました。
# DEMO
...
- 色使いに留意してデザインを行いました。寒色系の色は食欲を抑制するので温かみのある色を使用しております。

- シンプルな使い心地を意識して制作した。機能を豊富にしすぎると迷いを生み、脳のエネルギーを消費すると考えたためあえて少なくしています。
