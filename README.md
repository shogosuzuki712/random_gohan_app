...
ユーザー管理機能、投稿機能、一覧表示機能、検索機能、編集機能、削除機能、ユーザー詳細機能です。

ログインユーザーのトップページには全ユーザーの投稿一覧が表示されます。

ログインユーザーは投稿機能や検索機能を使用できます。検索機能を使用すると、全ての投稿の中から1つ無作為に表示します。

また、自身の投稿は編集・削除することができます。

任意の投稿画像を押下すると投稿ユーザーの詳細ページへ遷移し、投稿一覧が表示できます。
...
実際、私も一人暮らしをしていた頃は食事の時間に何を食べようか悩み、何度かストレスを感じた経験がありました。

そこで、一人暮らしの方、主婦をターゲットとし、食事の時間に何を食べればよいか決めてくれるアプリケーションがあれば便利だなと思い、制作しました。
...
[![Image from Gyazo](https://i.gyazo.com/7eb72bb198360cade05e3b046662c7ea.gif)](https://gyazo.com/7eb72bb198360cade05e3b046662c7ea)

# 工夫したポイント

- 色使いに留意しております。寒色系の色は食欲を抑制するので、暖色で揃えデザインを行いました。

- レスポンシブデザインを採用しました。スマホ、タブレット、PCそれぞれに適応したviewが表示できます。
